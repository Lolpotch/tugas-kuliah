...
public:
    ...
    void displayCart() const{
        const CartItem* current = cartHead;
    ...
    while (current != nullptr) {
        cout << "Name: " << current->name
             ...
             << ", Subtotal: Rp " << current->quantity * current->price << endl;
        current = current->next;
    }
    }

    void checkout() {
        // This is a placeholder function; you need to implement actual checkout functionality
    ...
    while (true) {
        ...
        if (choice == "1") {
            ...
            if (loginSuccessful && username == "admin") {
                ...
                UserMenu(inventory); //display list barang
            } else {
